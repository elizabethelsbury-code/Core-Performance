...
function renderProgramEditor(main){
  ...
  DAY_ORDER.forEach(k=>{
    ...
    if(d.type !== 'lift'){
      ...
      html += `<button class="addExEdit" data-day="${k}" style="background:none;border:none;color:var(--steel);font-family:var(--font-mono);font-size:11px;margin-top:2px;">+ Add exercise</button>`;
    }
    html += `</div>`;
  });
  main.innerHTML = html;
