...
function renderCheckin(main){
  ...
  let html = `<div class="field" style="margin-bottom:14px;"><label>Date</label>
    <input type="date" id="checkinDateInput" value="${checkinDate}"></div>`;
...
function renderLog(main){
  ...
  html += `<div class="field" style="margin-bottom:10px;"><label>Date</label><input type="date" id="logDate" value="${logState.date}"></div>
