...
function showBlockReportPopup(onAcknowledge){
  ...
  ov.innerHTML = `<div style="background:var(--surface);border-radius:16px 16px 0 0;padding:20px 18px 24px;width:100%;max-width:520px;max-height:88vh;overflow-y:auto;">
    ...
    <button id="blockReportEmailBtn" class="pill" style="width:100%;padding:11px;margin-bottom:14px;">&#128231; Email this report</button>
...
function renderReport(main){
  ...
  <button id="emailReportBtn" class="pill" style="width:100%;padding:11px;margin-bottom:14px;">&#128231; Email this report</button>`;
...
document.getElementById('exportDataBtn').onclick = ()=>{
  const backup = {
    ...
    sessions, cycleEntries, settings, PLAN, goals, readinessEntries, measureEntries, templates,
  };
